...
const CoachFive = () => {
    const coachingLeadership = [
        ...
        { 
            title: "Head Coach, Women's Team",
            description: "2022 Commonwealth Games",
            icon: Users
        },
        { 
            title: "Head Coach, Women's Team",
            description: "PanAm Senior Championships",
            icon: Users
        },
        { 
            title: "Head Coach, Girls Team",
            description: "PanAm Junior Championships",
            icon: Users
        },
        { 
    ...
    const canadianNationalChampionships = [
        { event: "Women's Singles", result: "Champion", type: "gold" },
        { event: "Women's Doubles", result: "Champion", type: "gold" },
                ...
                <div className="relative px-6 py-16 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl md:text-2xl text-gray-300 font-light">
                            NCCP Certified Professional Coach & National Champion
                        </p>
            ...
            <div className="max-w-6xl mx-auto px-6 pb-16">
                ...
                <section className="mb-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {canadianNationalChampionships.map((championship, index) => (
                    ...
                    <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/30 rounded-2xl p-8 border border-gray-600">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="text-gray-300">Commonwealth Games</div>
                            </div>
                            <div className="space-y-2">
                                <div className="text-3xl font-bold text-blue-400">2</div>
                                <div className="text-gray-300">PanAm Championships</div>
                            </div>
                            <div className="space-y-2">
