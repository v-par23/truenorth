...
const CoachSeven = () => {
    const background = [
        { 
            title: "Trained at Chinese National Junior Team",
            description: "Elite training at national level",
            icon: Target
        },
        { 
        ...
        { 
            title: "Former Beijing Team Member",
            description: "Regional team experience",
            icon: Users
        },
        { 
            title: "Former Coach",
